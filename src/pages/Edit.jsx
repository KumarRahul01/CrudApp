  ...
  return (
    <div className="w-full min-h-screen pt-28 dark:bg-zinc-800 bg-zinc-100 dark:text-slate-50 relative">
      ...
      <form method="post" className="flex flex-col gap-5 w-10/12 mx-auto">
        ...
        <input
          className="p-2 text-black bg-slate-300 rounded mb-5"
          value={name}
        ...
        <input
          className="p-2 text-black bg-slate-300 rounded"
          value={email}
        ...
        />
        <button
          className="bg-blue-500 w-fit px-4 py-2 rounded-lg text-white font-semibold mt-10"
